...
import 'package:carder/src/card_animation.dart';
import 'package:carder/src/controller/controller_event.dart';
import 'package:carder/src/utils/number_extension.dart';
import 'package:carder/src/utils/undoable.dart';
import 'package:flutter/widgets.dart';

part 'card_swiper_state.dart';

class CarderSwiper extends StatefulWidget {
  ...
  final CarderController? controller;
  ...
  @override
  State createState() => _CarderSwiperState();
}
